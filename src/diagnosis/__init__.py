...
records_routes.add_url_rule("/update_diagnosis", "records_controllers_update_diagnosis", controller.update_diagnosis, methods=['POST'])
records_routes.add_url_rule("/delete_diagnosis", "records_controllers_delete_diagnosis", controller.delete_diagnosis, methods=['POST'])
